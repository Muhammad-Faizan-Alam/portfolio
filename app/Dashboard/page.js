...
const Dashboard = () => {
  return (
    <div className="relative w-full h-screen">
      ...
      h-[70vh] rounded-sm z-50
      bg-[url('https://plus.unsplash.com/premium_photo-1722111091429-dd3dc55979d3?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fGFsaWVuc3xlbnwwfDB8MHx8fDA%3D')] bg-no-repeat bg-center bg-cover">
        <div className='w-[100%] h-[100%] grid grid-cols-2 gap-[10%] p-10 rounded-sm'>
            <Intro/>
        </div>
      </div>
